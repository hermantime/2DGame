...
struct BulletConfig {float B_SHAPE_RAD, B_COLLISION_RAD; int B_F_COLOR_R, B_F_COLOR_G, B_F_COLOR_B, B_O_COLOR_R, B_O_COLOR_G, B_O_COLOR_B, B_O_THICKNESS, B_SHAPE_VERT, B_LIFE; float B_SPEED;};
